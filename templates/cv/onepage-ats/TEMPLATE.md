...
- **Contact line:** email, phone, and location are printed as literal text next to their icons — never carried by an icon or a link target alone (an ATS cannot read an icon or a hyperlink destination).
