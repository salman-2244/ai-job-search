...
{\centering
  ...
  \vspace{3pt}
  {\small
    \faEnvelope\ \href{mailto:[YOUR_EMAIL]}{[YOUR_EMAIL]} \quad
    \faPhone*\ [YOUR_PHONE] \quad
    \faMapMarker*\ [YOUR_LOCATION] \\[1pt]
    \faLinkedin\ \href{[YOUR_LINKEDIN_URL]}{[YOUR_LINKEDIN_HANDLE]} \quad
    \faGithub\ \href{[YOUR_GITHUB_URL]}{[YOUR_GITHUB_HANDLE]}
  }\par
}
\vspace{2pt}
